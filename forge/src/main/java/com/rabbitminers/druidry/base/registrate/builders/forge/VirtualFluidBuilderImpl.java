...
public class VirtualFluidBuilderImpl<T extends DruidryFlowingFluid, P> extends VirtualFluidBuilder<T, P> {
    ...
    public VirtualFluidBuilderImpl(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture,
        ...
        this(owner, parent, name, callback, stillTexture, flowingTexture, VirtualFluidBuilderImpl::defaultFluidType, fluidFactory);
    }
    ...
    @Override
    public VirtualFluidBuilder<T, P> defaultLang() {
        return (VirtualFluidBuilderImpl<T, P>) lang(f -> f.getFluidType().getDescriptionId(), RegistrateLangProvider.toEnglishName(sourceName));
    }

    @Override
    public VirtualFluidBuilder<T, P> lang(String name) {
        return (VirtualFluidBuilderImpl<T, P>) lang(f -> f.getFluidType().getDescriptionId(), name);
    }
    ...
    public VirtualFluidBuilder<T, P> defaultSource() {
    ...
    @Override
    public VirtualFluidBuilder<T, P> defaultBlock() {
    ...
    public VirtualFluidBuilder<T, P> defaultBucket() {
