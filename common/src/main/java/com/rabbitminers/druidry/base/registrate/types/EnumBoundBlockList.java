...
public class EnumBoundBlockList<T extends Block, E extends Enum<E>> implements Iterable<BlockEntry<T>> {
    private final BlockEntry<?>[] values;

    public EnumBoundBlockList(Class<E> e, Function<E, BlockEntry<? extends T>> filler) {
