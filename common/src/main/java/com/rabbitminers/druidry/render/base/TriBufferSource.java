package com.rabbitminers.druidry.render.base;
...
public class TriBufferSource implements MultiBufferSource {
    private static final TriBufferSource INSTANCE = new TriBufferSource();

    public static TriBufferSource getInstance() {
        return INSTANCE;
    }

    private TriBufferRenderPhase earlyBuffer;
    private TriBufferRenderPhase defaultBuffer;
    private TriBufferRenderPhase lateBuffer;

    public TriBufferSource() {
        earlyBuffer = new TriBufferRenderPhase();
        defaultBuffer = new TriBufferRenderPhase();
        lateBuffer = new TriBufferRenderPhase();
    }
    ...
    private static class TriBufferRenderPhase {
